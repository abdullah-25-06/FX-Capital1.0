...
const Markets = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-900 via-blue-900 to-slate-900 p-2 sm:p-4 lg:p-6'>
      <div className='max-w-7xl mx-auto'>
        {/* Markets Table */}
        <div className='bg-slate-800/40 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl border border-slate-700/50 overflow-hidden'>
          {/* Header */}
          <div className='bg-slate-800/80 backdrop-blur-sm p-3 sm:p-4 lg:p-6 border-b border-slate-700/50'>
            <h2 className='text-lg sm:text-xl lg:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-500 text-center'>
              Transaction Quote
            </h2>
          </div>
            ...
            <table className='min-w-full text-sm'>
              ...
              <tbody>
                {tradingPairs.map((coin, index) => (
                  <tr
                    key={index}
                    className='border-b border-slate-700/30 hover:bg-slate-700/30 transition-all duration-300 cursor-pointer group'
                  >
                    ...
                    <td className='py-4 px-6 text-blue-400 font-semibold text-base'>
                      {coin.pair}
                    </td>
                    <td className='py-4 px-6'>
                      <span className='inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-500/20 text-green-400 border border-green-500/40 shadow-sm'>
          ...
          <div className='lg:hidden'>
            {tradingPairs.map((coin, index) => (
              <div
                key={index}
                className='border-b border-slate-700/30 p-3 sm:p-4 hover:bg-slate-700/20 transition-all duration-300 cursor-pointer'
              >
