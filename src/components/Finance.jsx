...
const Finance = () => {
  return (
    <div className="bg-[#0F172A] min-h-screen px-2 sm:px-4 py-0">
      {/* Card */}
      <div className="bg-[#1A1A1A] w-full rounded-2xl shadow-lg p-5 mx-auto mt-0">
        ...
        <div className="flex justify-between mb-5">
          <button className="flex flex-col items-center bg-[#2a2a2a] text-white flex-1 mx-1 py-3 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition">
